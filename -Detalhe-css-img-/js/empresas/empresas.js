...
async function empresaGetAll() {
  ...
  const response = await fetch("https://blonde-donkey-pmaycon63-f6d1bba7.koyeb.app/empresa/all", {
    method: "GET",
    headers: {
...
function PerfilUsuarioVisivelAEmpresa() {
  ...
  $.ajax({
    url: 'https://blonde-donkey-pmaycon63-f6d1bba7.koyeb.app/usuario/' + usuarioId,
    type: "GET",
    crossDomain: true,
    contentType: "application/json",
    dataType: "json",
...
function AdminPerfilSobre(idEmpresaLogin) {
  $("#preloader").show();
  $.ajax({
    url: "https://blonde-donkey-pmaycon63-f6d1bba7.koyeb.app/empresa/" + idEmpresaLogin,
    type: "GET",
    crossDomain: true,
    contentType: "application/json",
    dataType: "json",
...
function usuarioVagaPerfil(idVagaUsuarioCand) {
  window.location.href = '/z-Novo_TCC/Vaga/perfilVaga/vagaPerfil.html?id=' + idVagaUsuarioCand;
}
...
function AdminPerfilUsuarios() {
  ...
  $.ajax({
    url: "https://blonde-donkey-pmaycon63-f6d1bba7.koyeb.app/usuarioVaga/listarTodosUsuarioVaga",
    type: "GET",
    crossDomain: true,
    contentType: "application/json",
    dataType: "json",
        ...
        if (idsVagasCadastradas.includes(candidatura.vaga_id)) {
          ...
          if (!usuariosCandidatados[idVaga].includes(idUsuario)) {
            ...
            var promise = new Promise(function (resolve, reject) {
              $.ajax({
                url: "https://blonde-donkey-pmaycon63-f6d1bba7.koyeb.app/usuario/" + idUsuario,
                type: "GET",
                crossDomain: true,
                contentType: "application/json",
                dataType: "json",
                success: function (response) {
                  ...
                  $.ajax({
                    url: "https://blonde-donkey-pmaycon63-f6d1bba7.koyeb.app/vagas/" + idVaga,
                    type: "GET",
                    crossDomain: true,
                    contentType: "application/json",
                    dataType: "json",
...
function DarLike(el, usuarioId, empresaId) {
  ...
  $.ajax({
    ...
    success: function (response) {
      ...
      $.ajax({
        url: 'https://blonde-donkey-pmaycon63-f6d1bba7.koyeb.app/usuario/darLikeEmUsuario/' + UsuarioId + '/' + EmpresaNome,
        type: "PUT",
        crossDomain: true,
        contentType: "application/json",
        success: function (response) {
...
function NaoDarLike(el, usuarioId, empresaId) {
  ...
  $.ajax({
    ...
    success: function (response) {
      ...
      $.ajax({
        url: 'https://blonde-donkey-pmaycon63-f6d1bba7.koyeb.app/usuario/naodarLikeEmUsuario/' + UsuarioId + '/' + EmpresaNome,
        type: "PUT",
        crossDomain: true,
        contentType: "application/json",
        success: function (response) {
...
function rejectUser(el, usuarioId, empresaId) {
  ...
  $.ajax({
    ...
    success: function (response) {
      ...
      $.ajax({
        url: 'https://blonde-donkey-pmaycon63-f6d1bba7.koyeb.app/usuario/dispensarUsuario/' + UsuarioId + '/' + EmpresaNome,
        type: "PUT",
        crossDomain: true,
        contentType: "application/json",
        success: function (response) {
